...
dfscores_log = np.log(dfscores)

# concatenate two dataframes for better visualization
featureScores = pd.concat([dfcolumns,dfscores_log], axis = 1)
featureScores.columns = ['Specs', 'Log_Score'] # name the dataframe columns

print(featureScores.nlargest(10,'Log_Score')) # print 10 best features